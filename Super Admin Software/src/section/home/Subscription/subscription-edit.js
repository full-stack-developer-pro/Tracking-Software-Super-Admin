...
const EditSubscriptionSection = () => {
    ...
    const getSinglelesson = () => {
        DataService.getSingleSubscription(params.id).then((data) => {
            setData(data?.data?.data);

            setSubscriptionName(data?.data?.data?.name)
    ...
    const handleSubmit = (e) => {
        ...
        const data = {
            ...
            DataService.UpdateSubscription(params.id,data).then(
                () => {
...
export default EditSubscriptionSection;