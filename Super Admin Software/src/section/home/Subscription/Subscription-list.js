...
const AllSubscriptionList = () => {
    ...
    const getData = () => {
        if(storedUserId){
            DataService.getSubscription().then((data) => {
                //const vanuesFromVenueModel = data?.data?.data?.vanuesFromVenueModel || [];
                //const venuesFromVenueOwnerModel = data?.data?.data?.venuesFromVenueOwnerModel || [];
                
                // Combine data from both arrays
                //const combinedData = [...vanuesFromVenueModel, ...venuesFromVenueOwnerModel];
    ...
    const deleteSubscription  = (item) =>{
        setLoading(true);
        DataService.deleteSubscription(item?._id).then(
            () => {
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-12">
                <h4 className="f-700 mb-4">All Subsciption</h4>
                {message && (
                ...
                <div className="table-header d-flex align-items-center">
                    ...
                    <form class="d-flex align-items-center ms-auto">
                        ...
                        <Link to={"/add-subscription"} className="btn btn-secondary">Add Subsciption</Link>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col">Subsciption Name</th>
                            <th scope="col">Subsciption Type</th>
                            <th scope="col">Subsciption Plan</th>
                            <th scope="col">Subsciption Price</th>
                            ...
                            ? data.map((item, i) => (
                                <tr style={{ whiteSpace: "nowrap" }}>
                                    ...
                                    <td width="150"><span className="d-flex justify-content-end">
                                        ...
                                        <Link to={"/edit-subscription/" + item._id} className="mx-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body py-5">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => {deleteSubscription(item) } }>Yes</button>
                                                        </div>
                                                        </div>
                                                    </div>
