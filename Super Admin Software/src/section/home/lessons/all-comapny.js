...
const AllCompany = () => {
    ...
    const getData = () => {
        if(storedUserId){
            DataService.getCompany().then((data) => {
    ...
    const deleteCompany  = (item) =>{
        setLoading(true);
        DataService.deleteCompany(item?._id).then(
            () => {
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-12">
                <h4 className="f-700 mb-4">All Company</h4>
                {message && (
                ...
                <div className="table-header d-flex align-items-center">
                    ...
                    <form class="d-flex align-items-center ms-auto">
                        ...
                        <Link to={"/add-company"} className="btn btn-secondary">Add Company</Link>
                            ...
                            ? data.map((item, i) => (
                                <tr style={{ whiteSpace: "nowrap" }}>
                                    ...
                                    <td width="150"><span className="d-flex justify-content-end">
                                        ...
                                        <Link to={"/edit-company/" + item._id} className="mx-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body py-5">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => {deleteCompany(item) } }>Yes</button>
                                                        </div>
                                                        </div>
                                                    </div>
